            ...
            <div className="w-full h-[70vh] mt-48 bg-cover bg-center flex items-center" style={{ backgroundImage: `url('https://images.contentstack.io/v3/assets/bltb6530b271fddd0b1/bltaf4dae47b30c2172/5fd2d140a84f233eaf61091a/VALORANT_Logo_V.jpg')` }}>
                <div className="w-full flex">
                    ...
                    <div className="flex items-center flex-col justify-center ">
                        <h1 className=" text-7xl uppercase text-white font-anton font-bold cursor-pointer duration-700 ease-in-out select-none">Agents</h1>
                        <Link to={'/agents'}>
                            <p className="mt-10 text-white underline font-semibold duration-500 rounded hover:bg-red-200 hover:no-underline hover:text-black hover:p-3">CHECK THE HEADCOUNT</p>
                        </Link>
                    </div>
                </div>
            </div>
